...
bool ExportFeq::writeFeq(ReadExperiment& readExp,
        SailfishOpts& sopt,
        const boost::filesystem::path& feqOutputPath //for MAX
        ){ 
    ...
    std::cout << "=========================================================================\n" << std::endl;
    std::cout << "[MAX] -- We are export some data here -- \n" << std::endl;
    std::cout << "=========================================================================\n" << std::endl;
        std::cout << "[MAX] -- Export fragment information \n" << std::endl; 
    ...
    std::cout << "[MAX] -- Extracting equivalence class \n" << std::endl;
